// Admin Update Employee - Load and update employee details
...
function setupForm() {
    ...
    form.addEventListener('submit', async function(e) {
        ...
        try {
            const response = await fetch(`/api/accounts/admin/employee/${userId}/update/`, {
                method: 'PATCH',
            ...
            if (response.ok) {
                ...
                setTimeout(() => window.location.href = `/api/accounts/staff/user/${userId}/`, 1500);
            } else {
